          ...
          <>
            ...
            >
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="group bg-card rounded-xl p-6 shadow-lg border border-border/50 hover:shadow-xl hover:shadow-primary/40 hover:border-primary/50 transition-all duration-300"
                >
