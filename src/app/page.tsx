    ...
    <div className="container relative py-8">
      {status === 'idle' && (
        <section className="pb-12 md:pb-24 text-center animate-in fade-in-0 slide-in-from-bottom-12 duration-500">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-4 bg-gradient-to-r from-primary via-chart-2 to-primary bg-clip-text text-transparent animate-text-gradient-pan" style={{ backgroundSize: '200% 200%' }}>
